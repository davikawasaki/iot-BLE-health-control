...
class AppModuleInjector extends import0.NgModuleInjector<import1.AppModule> {
  ...
  get _APP_ID_29():any {
    if ((this.__APP_ID_29 == (null as any))) { (this.__APP_ID_29 = import59._appIdRandomProviderFactory()); }
  ...
  get _EventManager_33():import16.EventManager {
    if ((this.__EventManager_33 == (null as any))) { (this.__EventManager_33 = new import16.EventManager(this._EVENT_MANAGER_PLUGINS_32,this.parent.get(import63.NgZone))); }
  ...
  get _RootRenderer_37():any {
    if ((this.__RootRenderer_37 == (null as any))) { (this.__RootRenderer_37 = import64._createConditionalRootRenderer(this._DomRootRenderer_36,this.parent.get(import64.NgProbeToken,(null as any)))); }
  ...
  get _AppRootToken_53():any {
    if ((this.__AppRootToken_53 == (null as any))) { (this.__AppRootToken_53 = import65.MyApp); }
  ...
  get _Keyboard_61():import34.Keyboard {
    if ((this.__Keyboard_61 == (null as any))) { (this.__Keyboard_61 = new import34.Keyboard(this._Config_21,this._Form_58,this.parent.get(import63.NgZone))); }
  ...
  get _LocationStrategy_63():any {
    if ((this.__LocationStrategy_63 == (null as any))) { (this.__LocationStrategy_63 = import8.provideLocationStrategy(this.parent.get(import66.PlatformLocation),this.parent.get(import67.APP_BASE_HREF,(null as any)),this._Config_21)); }
  ...
  get _TapClick_69():import41.TapClick {
    if ((this.__TapClick_69 == (null as any))) { (this.__TapClick_69 = new import41.TapClick(this._Config_21,this._App_22,this.parent.get(import63.NgZone))); }
  ...
  get _UrlSerializer_73():any {
    if ((this.__UrlSerializer_73 == (null as any))) { (this.__UrlSerializer_73 = import68.setupUrlSerializer(this._DeepLinkConfigToken_54)); }
    return this.__UrlSerializer_73;
  }
  get _DeepLinker_74():any {
    if ((this.__DeepLinker_74 == (null as any))) { (this.__DeepLinker_74 = import69.setupDeepLinker(this._App_22,this._UrlSerializer_73,this._Location_64)); }
  ...
  createInternal():import1.AppModule {
    ...
    this._APP_INITIALIZER_23 = [
      ...
      import41.setupTapClick(this._Config_21,this._App_22,this.parent.get(import63.NgZone))
    ]
    ;
    ...
    this._ApplicationRef__26 = new import13.ApplicationRef_(this.parent.get(import63.NgZone),this.parent.get(import76.Console),this,this._ErrorHandler_11,this,this._ApplicationInitStatus_24,this.parent.get(import12.TestabilityRegistry,(null as any)),this._Testability_25);
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import77.LOCALE_ID)) { return this._LOCALE_ID_9; }
    if ((token === import9.NgLocalization)) { return this._NgLocalization_10; }
    if ((token === import78.ErrorHandler)) { return this._ErrorHandler_11; }
    if ((token === import73.ConfigToken)) { return this._ConfigToken_12; }
    if ((token === import70.UrlToken)) { return this._UrlToken_13; }
    if ((token === import70.QueryParams)) { return this._QueryParams_14; }
    if ((token === import71.PlatformConfigToken)) { return this._PlatformConfigToken_15; }
    if ((token === import72.UserAgentToken)) { return this._UserAgentToken_16; }
    if ((token === import72.NavigatorPlatformToken)) { return this._NavigatorPlatformToken_17; }
    if ((token === import72.DocumentDirToken)) { return this._DocumentDirToken_18; }
    if ((token === import72.DocLangToken)) { return this._DocLangToken_19; }
    if ((token === import72.Platform)) { return this._Platform_20; }
    if ((token === import73.Config)) { return this._Config_21; }
    ...
    if ((token === import59.APP_ID)) { return this._APP_ID_29; }
    if ((token === import79.DOCUMENT)) { return this._DOCUMENT_30; }
    if ((token === import62.HAMMER_GESTURE_CONFIG)) { return this._HAMMER_GESTURE_CONFIG_31; }
    ...
    if ((token === import80.AnimationDriver)) { return this._AnimationDriver_35; }
    if ((token === import18.DomRootRenderer)) { return this._DomRootRenderer_36; }
    if ((token === import81.RootRenderer)) { return this._RootRenderer_37; }
    if ((token === import19.DomSanitizer)) { return this._DomSanitizer_38; }
    if ((token === import82.Sanitizer)) { return this._Sanitizer_39; }
    if ((token === import20.ViewUtils)) { return this._ViewUtils_40; }
    if ((token === import83.IterableDiffers)) { return this._IterableDiffers_41; }
    if ((token === import84.KeyValueDiffers)) { return this._KeyValueDiffers_42; }
    ...
    if ((token === import87.AppRootToken)) { return this._AppRootToken_53; }
    if ((token === import68.DeepLinkConfigToken)) { return this._DeepLinkConfigToken_54; }
    ...
    if ((token === import67.LocationStrategy)) { return this._LocationStrategy_63; }
    ...
    if ((token === import68.UrlSerializer)) { return this._UrlSerializer_73; }
    if ((token === import69.DeepLinker)) { return this._DeepLinker_74; }
    if ((token === import88.TRANSLATIONS_FORMAT)) { return this._TRANSLATIONS_FORMAT_75; }
