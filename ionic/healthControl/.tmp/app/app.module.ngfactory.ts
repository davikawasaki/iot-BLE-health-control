...
class AppModuleInjector extends import0.NgModuleInjector<import1.AppModule> {
  ...
  get _Keyboard_61():import34.Keyboard {
    if ((this.__Keyboard_61 == (null as any))) { (this.__Keyboard_61 = new import34.Keyboard(this._Config_21,this._Form_58,this.parent.get(import65.NgZone))); }
  ...
  get _LocationStrategy_63():any {
    if ((this.__LocationStrategy_63 == (null as any))) { (this.__LocationStrategy_63 = import8.provideLocationStrategy(this.parent.get(import68.PlatformLocation),this.parent.get(import69.APP_BASE_HREF,(null as any)),this._Config_21)); }
  ...
  get _TapClick_69():import41.TapClick {
    if ((this.__TapClick_69 == (null as any))) { (this.__TapClick_69 = new import41.TapClick(this._Config_21,this._App_22,this.parent.get(import65.NgZone))); }
  ...
  get _UrlSerializer_73():any {
    if ((this.__UrlSerializer_73 == (null as any))) { (this.__UrlSerializer_73 = import70.setupUrlSerializer(this._DeepLinkConfigToken_54)); }
    return this.__UrlSerializer_73;
  }
  get _DeepLinker_74():any {
    if ((this.__DeepLinker_74 == (null as any))) { (this.__DeepLinker_74 = import71.setupDeepLinker(this._App_22,this._UrlSerializer_73,this._Location_64)); }
  ...
  createInternal():import1.AppModule {
    ...
    this._APP_INITIALIZER_23 = [
      ...
      import41.setupTapClick(this._Config_21,this._App_22,this.parent.get(import65.NgZone))
    ]
    ;
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import69.LocationStrategy)) { return this._LocationStrategy_63; }
    ...
    if ((token === import70.UrlSerializer)) { return this._UrlSerializer_73; }
    if ((token === import71.DeepLinker)) { return this._DeepLinker_74; }
    if ((token === import90.TRANSLATIONS_FORMAT)) { return this._TRANSLATIONS_FORMAT_75; }
