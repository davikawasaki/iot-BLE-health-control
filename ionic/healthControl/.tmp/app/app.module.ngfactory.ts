...
import * as import56 from '../pages/historico/historico.ngfactory';
import * as import57 from '../pages/historico-filho/historico-filho.ngfactory';
import * as import58 from '../pages/bluetooth/bluetooth.ngfactory';
import * as import59 from '../pages/device/device.ngfactory';
...
import * as import63 from '@angular/platform-browser/src/dom/events/hammer_gestures';
...
import * as import66 from './app.component';
...
import * as import69 from 'ionic-angular/navigation/url-serializer';
import * as import70 from 'ionic-angular/navigation/deep-linker';
import * as import71 from 'ionic-angular/platform/query-params';
import * as import72 from 'ionic-angular/platform/platform-registry';
import * as import73 from 'ionic-angular/platform/platform';
import * as import74 from 'ionic-angular/config/config';
import * as import75 from 'ionic-angular/config/mode-registry';
import * as import76 from 'ionic-angular/transitions/transition-registry';
...
class AppModuleInjector extends import0.NgModuleInjector<import1.AppModule> {
  ...
  constructor(parent:import45.Injector) {
    super(parent,[
      ...
      import56.HistoricoNgFactory,
      import57.HistoricoFilhoNgFactory,
      import58.BluetoothNgFactory,
      import59.DeviceNgFactory,
      import48.IonicAppNgFactory
    ]
    ,[import48.IonicAppNgFactory]);
  }
  ...
  get _APP_ID_29():any {
    if ((this.__APP_ID_29 == (null as any))) { (this.__APP_ID_29 = import60._appIdRandomProviderFactory()); }
  ...
  get _EVENT_MANAGER_PLUGINS_32():any[] {
    if ((this.__EVENT_MANAGER_PLUGINS_32 == (null as any))) { (this.__EVENT_MANAGER_PLUGINS_32 = [
      ...
      new import63.HammerGesturesPlugin(this._HAMMER_GESTURE_CONFIG_31)
    ]
    ); }
    return this.__EVENT_MANAGER_PLUGINS_32;
  }
  get _EventManager_33():import16.EventManager {
    if ((this.__EventManager_33 == (null as any))) { (this.__EventManager_33 = new import16.EventManager(this._EVENT_MANAGER_PLUGINS_32,this.parent.get(import64.NgZone))); }
  ...
  get _RootRenderer_37():any {
    if ((this.__RootRenderer_37 == (null as any))) { (this.__RootRenderer_37 = import65._createConditionalRootRenderer(this._DomRootRenderer_36,this.parent.get(import65.NgProbeToken,(null as any)))); }
  ...
  get _AppRootToken_53():any {
    if ((this.__AppRootToken_53 == (null as any))) { (this.__AppRootToken_53 = import66.MyApp); }
  ...
  get _Keyboard_61():import34.Keyboard {
    if ((this.__Keyboard_61 == (null as any))) { (this.__Keyboard_61 = new import34.Keyboard(this._Config_21,this._Form_58,this.parent.get(import64.NgZone))); }
  ...
  get _LocationStrategy_63():any {
    if ((this.__LocationStrategy_63 == (null as any))) { (this.__LocationStrategy_63 = import8.provideLocationStrategy(this.parent.get(import67.PlatformLocation),this.parent.get(import68.APP_BASE_HREF,(null as any)),this._Config_21)); }
  ...
  get _TapClick_69():import41.TapClick {
    if ((this.__TapClick_69 == (null as any))) { (this.__TapClick_69 = new import41.TapClick(this._Config_21,this._App_22,this.parent.get(import64.NgZone))); }
  ...
  get _UrlSerializer_73():any {
    if ((this.__UrlSerializer_73 == (null as any))) { (this.__UrlSerializer_73 = import69.setupUrlSerializer(this._DeepLinkConfigToken_54)); }
    return this.__UrlSerializer_73;
  }
  get _DeepLinker_74():any {
    if ((this.__DeepLinker_74 == (null as any))) { (this.__DeepLinker_74 = import70.setupDeepLinker(this._App_22,this._UrlSerializer_73,this._Location_64)); }
  ...
  createInternal():import1.AppModule {
    ...
    this._QueryParams_14 = import71.setupQueryParams(this._UrlToken_13);
    this._PlatformConfigToken_15 = import72.providePlatformConfigs();
    ...
    this._Platform_20 = import73.setupPlatform(this._PlatformConfigToken_15,this._QueryParams_14,this._UserAgentToken_16,this._NavigatorPlatformToken_17,this._DocumentDirToken_18,this._DocLangToken_19,this.parent.get(import64.NgZone));
    this._Config_21 = import74.setupConfig(this._ConfigToken_12,this._QueryParams_14,this._Platform_20);
    this._App_22 = new import10.App(this._Config_21,this._Platform_20);
    this._APP_INITIALIZER_23 = [
      import75.registerModeConfigs(this._Config_21),
      import76.registerTransitions(this._Config_21),
      import30.setupProvideEvents(this._Platform_20),
      import41.setupTapClick(this._Config_21,this._App_22,this.parent.get(import64.NgZone))
    ]
    ;
    this._ApplicationInitStatus_24 = new import11.ApplicationInitStatus(this._APP_INITIALIZER_23);
    this._Testability_25 = new import12.Testability(this.parent.get(import64.NgZone));
    this._ApplicationRef__26 = new import13.ApplicationRef_(this.parent.get(import64.NgZone),this.parent.get(import77.Console),this,this._ErrorHandler_11,this,this._ApplicationInitStatus_24,this.parent.get(import12.TestabilityRegistry,(null as any)),this._Testability_25);
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import78.LOCALE_ID)) { return this._LOCALE_ID_9; }
    if ((token === import9.NgLocalization)) { return this._NgLocalization_10; }
    if ((token === import79.ErrorHandler)) { return this._ErrorHandler_11; }
    if ((token === import74.ConfigToken)) { return this._ConfigToken_12; }
    if ((token === import71.UrlToken)) { return this._UrlToken_13; }
    if ((token === import71.QueryParams)) { return this._QueryParams_14; }
    if ((token === import72.PlatformConfigToken)) { return this._PlatformConfigToken_15; }
    ...
    if ((token === import88.AppRootToken)) { return this._AppRootToken_53; }
    if ((token === import69.DeepLinkConfigToken)) { return this._DeepLinkConfigToken_54; }
    ...
    if ((token === import68.LocationStrategy)) { return this._LocationStrategy_63; }
    ...
    if ((token === import89.TRANSLATIONS_FORMAT)) { return this._TRANSLATIONS_FORMAT_75; }
