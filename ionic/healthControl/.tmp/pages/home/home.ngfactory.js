...
var _View_HomePage0 = (function (_super) {
    ...
    _View_HomePage0.prototype.createInternal = function (rootSelector) {
        ...
        this._ToolbarItem_4_3 = new import13.ToolbarItem(this.parentInjector.get(import20.Config), new import21.ElementRef(this._el_4), this.renderer, this.parentInjector.get(import11.Toolbar, null), this._Navbar_2_4);
        ...
        this._MenuToggle_6_3 = new import15.MenuToggle(this.parentInjector.get(import25.MenuController), new import21.ElementRef(this._el_6), this.parentInjector.get(import22.ViewController, null), this._Navbar_2_4);
        this._ToolbarItem_6_4 = new import13.ToolbarItem(this.parentInjector.get(import20.Config), new import21.ElementRef(this._el_6), this.renderer, this.parentInjector.get(import11.Toolbar, null), this._Navbar_2_4);
        ...
        var compView_12 = import26.viewFactory_ToolbarTitle0(this.viewUtils, this.injector(12), this._appEl_12);
        this._ToolbarTitle_12_4 = new import17.ToolbarTitle(this.parentInjector.get(import20.Config), new import21.ElementRef(this._el_12), this.renderer, this.parentInjector.get(import11.Toolbar, null), this._Navbar_2_4);
        ...
        var compView_17 = import27.viewFactory_Content0(this.viewUtils, this.injector(17), this._appEl_17);
        ...
        this._el_22 = this.renderer.createElement(null, 'body', null);
        ...
        var compView_29 = import31.viewFactory_Button0(this.viewUtils, this.injector(29), this._appEl_29);
        this._Button_29_4 = new import19.Button(null, '', this.parentInjector.get(import20.Config), new import21.ElementRef(this._el_29), this.renderer);
        this._appEl_29.initComponent(this._Button_29_4, [], compView_29);
        this._text_30 = this.renderer.createText(null, 'Conectar', null);
    ...
    _View_HomePage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import19.Button) && ((29 <= requestNodeIndex) && (requestNodeIndex <= 30)))) {
            return this._Button_29_4;
        }
        if (((token === import18.Content) && ((17 <= requestNodeIndex) && (requestNodeIndex <= 31)))) {
...
export function viewFactory_HomePage0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_HomePage === null)) {
        (renderType_HomePage = viewUtils.createRenderComponentType('/home/davikawasaki/GitHub/healthcontrol/ionic/healthControl/.tmp/pages/home/home.html', 0, import9.ViewEncapsulation.None, styles_HomePage, {}));
    }
